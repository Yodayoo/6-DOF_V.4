...
path = "6-DOF_V.3/project_1/data/analytical_solutions/analytical_results.npy"
...
data = measure_batch_performance(analytical_ik_solve , targets , batch_size=10_000 , save_path=path)
