...
def generate_comparison_report(analytical_data, numerical_data):
    ...
    resource_table = [
        ...
        ["Memory Delta Median (MB)", format_value(a_mem_stats["median"], "f", 2),
         format_value(n_mem_stats["median"], "f", 2)],
        ["Memory Delta Max (MB)", format_value(a_mem_stats["max"], "f", 2),
         format_value(n_mem_stats["max"], "f", 2)],
        ["Memory Q25 (MB)", format_value(a_mem_stats["p25"], "f", 2),
         format_value(n_mem_stats["p25"], "f", 2)],
        ["Memory Q75 (MB)", format_value(a_mem_stats["p75"], "f", 2),
         format_value(n_mem_stats["p75"], "f", 2)],
        ["Memory IQR (MB)", format_value(a_mem_stats["iqr"], "f", 2),
         format_value(n_mem_stats["iqr"], "f", 2)],
        ...
        ["CPU Utilization Median (%)", format_value(a_cpu_stats["median"], "f", 1),
         format_value(n_cpu_stats["median"], "f", 1)],
        ["CPU Utilization Max (%)", format_value(a_cpu_stats["max"], "f", 1),
         format_value(n_cpu_stats["max"], "f", 1)],
        ["CPU Q25 (%)", format_value(a_cpu_stats["p25"], "f", 1),
         format_value(n_cpu_stats["p25"], "f", 1)],
        ["CPU Q75 (%)", format_value(a_cpu_stats["p75"], "f", 1),
         format_value(n_cpu_stats["p75"], "f", 1)],
        ["CPU IQR (%)", format_value(a_cpu_stats["iqr"], "f", 1),
         format_value(n_cpu_stats["iqr"], "f", 1)],
    ]
